...
class History extends \Magento\Framework\Model\AbstractModel implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    const CACHE_TAG = 'commercers_product_allocation_history';

    protected $_cacheTag = 'commercers_product_allocation_history';

    protected $_eventPrefix = 'commercers_product_allocation_history';
    ...
    {
        $this->_init('Commercers\ProductAllocation\Model\ResourceModel\History');
    }

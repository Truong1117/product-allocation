...
class CronCleanUpAllocation extends \Magento\Framework\App\Action\Action
{
    ...
    protected function cleanUpProductAllocationByCron(){
        $isProductEnable = $this->getIsProductEnable('Test-Product-Allocation-3');
        if (intval($isProductEnable) == 2) {
            echo "DISABLE";exit;
        }
        echo "ENABLE";exit;
        var_dump(intval($isProductEnable));exit;
